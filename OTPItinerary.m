...
- (void)sortLegs
{
    ...
    [super setSortedLegs:[[self legs] sortedArrayUsingDescriptors:[NSArray arrayWithObject:sortD]]];
}
...
- (PlanPlace *)to
{
    return [[[self sortedLegs] objectAtIndex:([super.sortedLegs count]-1)] to];
}
...
- (ItineraryCompareResult)compareItineraries:(OTPItinerary *)itin0
{
    if (self == itin0) {
...
- (NSString *)ncDescription
{
    ...
    for (OTPItinerary *leg in [self legs]) {
